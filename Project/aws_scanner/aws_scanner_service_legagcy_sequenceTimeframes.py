...
spot_scan_configs = [
    ...
    {
        "timeframe": "1d",
        "strategies": ["hbs_breakout", "vs_wakeup", "loaded_bar"],
    ...
    {
        "timeframe": "2d",
        "strategies": ["hbs_breakout", "vs_wakeup", "confluence", "consolidation_breakout", "channel_breakout", "loaded_bar"],
        "exchanges": spot_exchanges + ["binance_futures"],
        "users": ["default", "user1", "user2"],
        "send_telegram": True,
        "min_volume_usd": None
    ...
    {
        "timeframe": "3d",
        "strategies": ["hbs_breakout", "vs_wakeup", "confluence", "consolidation_breakout", "channel_breakout"],
        "exchanges": spot_exchanges + ["binance_futures"],
        "users": ["default", "user1", "user2"],
        "send_telegram": True,
        "min_volume_usd": None
    ...
    {
        "timeframe": "1w",
        "strategies": ["hbs_breakout", "vs_wakeup", "confluence", "consolidation_breakout", "channel_breakout", "volume_surge", "loaded_bar", "breakout_bar"],
        "exchanges": spot_exchanges + ["binance_futures"],
        "users": ["default", "user1", "user2"],
        "send_telegram": True,
        "min_volume_usd": None
